...
public interface IVonageService
{
    ...
    Task<ErrorOr<string>> SendSmsAsync(CallInfo callInfo, string transcript, string summarizedTranscriptText, string audioUrl, CancellationToken cancellationToken = default);
